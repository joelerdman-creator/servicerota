...
function initiateGoogleSignIn(authInstance) {
    ...
    // The promise is handled by the onAuthStateChanged listener.
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$node$2d$esm$2f$totp$2d$18137433$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__d__as__signInWithPopup$3e$__["signInWithPopup"])(authInstance, provider).catch((error)=>{
        // Handle errors here, such as user closing the popup.
        // We specifically want to ignore when the user cancels the popup.
...
const firebaseConfig = {
    ...
    "apiKey": "AIzaSyDlkaP_BDMBPYSyh38xIkDXlHmoS5O79CI",
...
function AuthProvider({ children }) {
    ...
    const signInWithGoogle = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
        if (auth) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$non$2d$blocking$2d$login$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["initiateGoogleSignIn"])(auth);
        } else {
            console.error("Auth service is not available for Google Sign-In.");
        }
    }, [
        auth
    ]);
    ...
    const toggleAdmin = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
        ...
        if (mockIsLoggedIn) {
            sessionStorage.setItem('isAdmin', String(newIsAdmin));
            setMockIsAdmin(newIsAdmin);
        }
        // For both mock and real users, redirect based on the new role.
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0f6df6ed._.js.map