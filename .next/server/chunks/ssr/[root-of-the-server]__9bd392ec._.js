...
function AuthProvider({ children }) {
    ...
    const handleUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (user)=>{
        ...
        if (user) {
            ...
            if (userDoc.exists()) {
                ...
                // Respect stored view preference if it exists
                const storedView = sessionStorage.getItem(`isAdminView_${user.uid}`);
                const shouldBeAdminView = storedView !== null ? storedView === 'true' : userIsAdmin;
                setIsAdminView(shouldBeAdminView);
                // Avoid redirecting if already on a valid page for the role
                const currentPath = window.location.pathname;
                const targetPath = shouldBeAdminView ? '/admin' : '/my-schedule';
            ...
            if (mockLogin) {
                ...
                // Clear all states for a full logout
    ...
    const setupMockUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (isAdmin)=>{
        if (!firestore) return;
        setIsUserLoading(true);
        // Clear any real user session
        if (auth.currentUser) await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$node$2d$esm$2f$totp$2d$18137433$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__D__as__signOut$3e$__["signOut"])(auth);
        sessionStorage.setItem('useMock', 'true');
        sessionStorage.setItem('isAdminView', String(isAdmin));
        // Lazy import mock data and setup
        const mockData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2d$lazy$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getMockData"])();
        ...
        const churchRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["doc"])(firestore, 'churches', MOCK_CHURCH_ID);
        batch.set(churchRef, mockData.church);
        mockData.volunteers.forEach((v)=>{
            const userRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["doc"])(firestore, 'users', v.id);
            batch.set(userRef, {
                ...v,
                churchId: MOCK_CHURCH_ID,
                role: v.id.includes('admin') ? 'admin' : 'volunteer'
            });
        });
        await batch.commit();
        setUseMock(true);
    ...
    const toggleAdmin = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
        ...
        // Store view preference per-user for real users
        if (firebaseUser) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(AuthContext.Provider, {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["FirebaseProvider"], {
            ...
            isUserLoading: isUserLoading,
            children: isUserLoading && !isLoggedIn ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9bd392ec._.js.map