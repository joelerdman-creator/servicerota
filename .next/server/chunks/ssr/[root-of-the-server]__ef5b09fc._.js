...
function useMemoFirebase(factory, deps) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(factory, useDeepCompareMemoize(deps));
}
const useUser = ()=>{
...
function FirebaseClientProvider({ children }) {
    const instances = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["initializeFirebase"])();
    }, []);
...
function AuthProvider({ children }) {
    const { firestore, auth, user: firebaseUser, isUserLoading: isAuthLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useFirebase"])();
    ...
    const [isTrulyAdmin, setIsTrulyAdmin] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const setupMockUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (isAdmin)=>{
        ...
        const { getMockData } = await __turbopack_context__.r("[project]/src/lib/mock-data-lazy.ts [app-ssr] (ecmascript, async loader)")(__turbopack_context__.i);
        ...
        volunteers.forEach((v)=>{
            batch.set((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["doc"])(firestore, 'users', v.id), v);
        });
        events.forEach((e)=>{
            const eventData = {
                ...e,
            ...
            batch.set((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["doc"])(firestore, 'churches', church.id, 'events', e.id), eventData);
        });
        universalRoles.forEach((ur)=>{
            batch.set((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["doc"])(firestore, 'churches', church.id, 'universalRoles', ur.id), ur);
        });
        serviceTemplates.forEach((st)=>{
            batch.set((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["doc"])(firestore, 'churches', church.id, 'serviceTemplates', st.id), st);
        });
        volunteerAvailability.forEach((va)=>{
            const availabilityData = {
                ...va,
                unavailableDates: va.unavailableDates
            };
            batch.set((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["doc"])(firestore, 'churches', church.id, 'volunteerAvailability', va.volunteerId), availabilityData);
        });
        families.forEach((f)=>{
            batch.set((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["doc"])(firestore, 'churches', church.id, 'families', f.id), f);
        });
        await batch.commit();
        setUseMock(true);
...
__turbopack_context__.s({
    ...
    "initializeFirebase": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["initializeFirebase"]),
    "useCollection": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$firestore$2f$use$2d$collection$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCollection"]),
    "useDoc": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$firestore$2f$use$2d$doc$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useDoc"]),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ef5b09fc._.js.map