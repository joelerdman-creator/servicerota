...
function useMockDatabase() {
    ...
    const toggleVolunteerAvailability = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (volunteerId, date)=>{
        setAvailability((prevAvailability)=>{
            ...
            const isUnavailable = prevAvailability.find((a)=>a.volunteerId === (targetIds[0] || ''))?.unavailableDates.some((d)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$isSameDay$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isSameDay"])(d, date)) ?? false;
            targetIds.forEach((id)=>{
                ...
                if (record) {
                    ...
                    let updatedDates;
                    if (volunteerId === 'all') {
                        updatedDates = isUnavailable ? record.unavailableDates.filter((d)=>!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$isSameDay$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isSameDay"])(d, date)) // Make available
                         : [
                            ...record.unavailableDates,
                            date
                        ]; // Make unavailable
                    } else {
                        updatedDates = dateExists ? record.unavailableDates.filter((d)=>!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$isSameDay$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isSameDay"])(d, date)) // Make available
                         : [
                            ...record.unavailableDates,
                            date
                        ]; // Make unavailable
                    ...
                    // If making available, nothing to do if no record exists.
                    // Only create a new record if marking as unavailable.
                    if (volunteerId === 'all' ? !isUnavailable : true) {
                        const newRecord = {
                            volunteerId: id,
                            unavailableDates: [
                                date
...
//# sourceMappingURL=src_3985681c._.js.map