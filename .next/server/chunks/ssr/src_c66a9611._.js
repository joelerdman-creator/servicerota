...
function useMockDatabase() {
    ...
    const addUniversalRole = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (name)=>{
        const newRole = {
            id: `urole_${Date.now()}`,
            name
        };
    ...
    const toggleVolunteerAvailability = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (volunteerId, date)=>{
        setAvailability((prev)=>{
            const availabilityRecord = prev.find((a)=>a.volunteerId === volunteerId);
            if (availabilityRecord) {
                const dateExists = availabilityRecord.unavailableDates.some((d)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$isSameDay$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isSameDay"])(d, date));
                const updatedDates = dateExists ? availabilityRecord.unavailableDates.filter((d)=>!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$isSameDay$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isSameDay"])(d, date)) : [
                    ...availabilityRecord.unavailableDates,
                    date
                ];
                return prev.map((a)=>a.volunteerId === volunteerId ? {
                        ...a,
...
function CreateEventModal({ isOpen, onClose, db }) {
...
function AdminPage() {
    ...
    const [isCreateModalOpen, setCreateModalOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
...
//# sourceMappingURL=src_c66a9611._.js.map