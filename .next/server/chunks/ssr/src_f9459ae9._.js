...
function RequestChangeModal({ isOpen, onClose, event, role, sendRequestAction }) {
    const { dataService, churchId } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$auth$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
    const { toast } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useToast"])();
    const [isSubmitting, setIsSubmitting] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    const [church, setChurch] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
...
const AppSidebar = ()=>{
    ...
    const { isAdmin, userId, churchId, dataService } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$auth$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        ;
        const unsub = dataService.getVolunteer(churchId, userId, (volunteer)=>{
            if (volunteer) {
        ...
        const handleStorageChange = ()=>{
            ...
            dataService.getVolunteer(churchId, userId, (volunteer)=>{
                if (volunteer) {
                    setFamilyManagementEnabled(volunteer.preferences.familyManagementEnabled);
                }
            });
...
function MySchedulePage() {
    const { dataService, churchId, userId, isLoggedIn, isAdmin } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$auth$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        setIsLoading(true);
        const unsubEvents = dataService.getEvents(churchId, (allEvents)=>{
            const myEvents = allEvents.filter((event)=>event.roles.some((role)=>role.assignedVolunteerId === userId)).sort((a, b)=>a.eventDate.getTime() - b.eventDate.getTime());
...
//# sourceMappingURL=src_f9459ae9._.js.map