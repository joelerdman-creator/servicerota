                ...
                "useFcmToken.useEffect.retrieveToken": async ()=>{
                    try {
                        if ("object" !== "undefined" && "serviceWorker" in navigator) {
                            const messaging = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$messaging$2f$dist$2f$esm$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMessaging"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__["firebaseApp"]);
...
_s(useFcmToken, "RHnrm1wnpqXS+WlEZGo1wBfrqUM=");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$fcm$2d$token$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/use-fcm-token.ts [app-client] (ecmascript)"); // Import the useFcmToken hook
;
...
// A new, isolated hook to handle the complex async logic of authentication.
const useFirebaseAuth = ()=>{
    _s();
    const { firestore, auth, user: fbUser, isUserLoading: isAuthServiceLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFirebase"])();
    const { token: fcmToken } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$fcm$2d$token$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(); // Get the FCM token
    ...
    const [isLoading, setIsLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useFirebaseAuth.useEffect": ()=>{
            const processAuthChange = {
                "useFirebaseAuth.useEffect.processAuthChange": async ()=>{
                    ...
                    setIsLoading(true);
                    try {
                        const userDocRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(firestore, 'users', fbUser.uid);
                        ...
                        let userProfile;
                        // If the user's profile doesn't exist in Firestore, they need to go through role selection.
                        if (!userDocSnap.exists()) {
                            setAppUser(null); // Explicitly set to null to trigger redirection to role selection
                            setIsLoading(false);
                            return;
                        }
                        userProfile = userDocSnap.data();
                        // If there's a new FCM token, update it in Firestore.
                        if (fcmToken && userProfile.fcmToken !== fcmToken) {
                            ...
                            userProfile.fcmToken = fcmToken; // Update the local profile object as well
                        }
                        const tokenResult = await fbUser.getIdTokenResult();
                        // Check if the custom claims on the token match what's in the user's Firestore document.
                        const claimsNeedUpdate = !tokenResult.claims.admin || tokenResult.claims.churchId !== userProfile.churchId;
                        let finalTokenResult = tokenResult;
                        if (claimsNeedUpdate) {
                            // If claims are missing or incorrect, call the API to set them.
                            ...
                            // CRITICAL: Force a refresh of the token to get the new claims immediately.
                            finalTokenResult = await fbUser.getIdTokenResult(true);
                        }
                        // Now that claims are guaranteed to be fresh, create the app user object.
                        const enrichedUser = {
                            ...userProfile,
                            id: fbUser.uid,
                            firebaseUser: fbUser,
                            token: finalTokenResult.claims
                        };
                        setAppUser(enrichedUser);
                    } catch (error) {
                        console.error("Auth Profile/Claims Error:", error);
                        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2d$8e6e89cb$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__D__as__signOut$3e$__["signOut"])(auth); // Sign out on error to prevent being in a broken state
                        setAppUser(null);
                    } finally{
                        setIsLoading(false); // Only set loading to false after all async operations are complete.
                    }
                }
            }["useFirebaseAuth.useEffect.processAuthChange"];
            processAuthChange();
        }
    }["useFirebaseAuth.useEffect"], [
        fbUser,
        ...
        auth,
        fcmToken
    ]); // Add fcmToken to the dependency array
    return {
        appUser,
        firebaseUser: fbUser,
...
_s(useFirebaseAuth, "+7I9iS7oZE/GBWECblcrQpTiAT4=", false, function() {
    return [
...
function AuthProvider({ children }) {
    ...
    const { appUser, firebaseUser, isUserLoading } = useFirebaseAuth();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            if (!isUserLoading) {
                if (firebaseUser) {
                    if (appUser) {
                        // User is logged in and has a profile with claims.
                        // Safe to proceed with role-based routing.
                        const currentPath = window.location.pathname;
                        if (appUser.role === 'admin') {
                            if (currentPath.startsWith('/my-') || currentPath === '/role-selection') {
                                router.push('/admin');
                            }
                        } else {
                            if (currentPath.startsWith('/admin') || currentPath === '/role-selection') {
                                router.push('/my-schedule');
                            }
                        }
                    } else {
                        // User is logged in (has firebaseUser) but has no app profile (appUser is null).
                        // They must select a role.
                        const currentPath = window.location.pathname;
                        // Allow them to be on role-selection or signup pages.
                        const isAllowedPath = currentPath.startsWith('/role-selection') || currentPath.startsWith('/signup');
                        if (!isAllowedPath) {
...
_s1(AuthProvider, "cvftTn6gFHohq2xI9sPMAeQEKAg=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFirebase"],
...
"[next]/internal/font/google/pt_sans_42896160.module.css [app-client] (css module)": ((__turbopack_context__) => {

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.v({
  "className": "pt_sans_42896160-module___95X_G__className",
  "variable": "pt_sans_42896160-module___95X_G__variable",
});
}}),
"[next]/internal/font/google/pt_sans_42896160.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$next$5d2f$internal$2f$font$2f$google$2f$pt_sans_42896160$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__ = __turbopack_context__.i("[next]/internal/font/google/pt_sans_42896160.module.css [app-client] (css module)");
;
const fontData = {
    className: __TURBOPACK__imported__module__$5b$next$5d2f$internal$2f$font$2f$google$2f$pt_sans_42896160$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].className,
    style: {
        fontFamily: "'PT Sans', 'PT Sans Fallback'",
        fontStyle: "normal"
    }
};
if (__TURBOPACK__imported__module__$5b$next$5d2f$internal$2f$font$2f$google$2f$pt_sans_42896160$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].variable != null) {
    fontData.variable = __TURBOPACK__imported__module__$5b$next$5d2f$internal$2f$font$2f$google$2f$pt_sans_42896160$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].variable;
}
...
'use client';
;
const FirebaseMessagingContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])(null);
...
const useFirebaseMessaging = ()=>{
    _s();
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(FirebaseMessagingContext);
};
_s(useFirebaseMessaging, "gDsCjeeItUuvgOWf1v4qoK9RF6k=");
var _c;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/utils.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$auth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/use-auth.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$next$5d2f$internal$2f$font$2f$google$2f$pt_sans_42896160$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[next]/internal/font/google/pt_sans_42896160.js [app-client] (ecmascript)");
...
const metadata = {
    title: "RotaScribe",
    description: "Volunteer Scheduling for Churches"
};
function RootLayout({ children }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("html", {
        ...
        className: `${__TURBOPACK__imported__module__$5b$next$5d2f$internal$2f$font$2f$google$2f$pt_sans_42896160$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].variable}`,
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("body", {
            className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])('font-body antialiased min-h-screen bg-background font-sans'),
...
_s(RootLayout, "qJDIPa3BTX+ry4/0gBxEDZ9m64o=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$fcm$2d$token$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]
    ];
});
...
//# sourceMappingURL=%5Broot-of-the-server%5D__92aff395._.js.map