...
"[project]/src/ai/flows/data:589060 [app-client] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/admin/volunteers/flyer/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$data$3a$589060__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/ai/flows/data:589060 [app-client] (ecmascript) <text/javascript>");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$scan$2d$qr$2d$code$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__ScanQrCode$3e$__ = __turbopack_context__.i("[project]/node_modules/lucide-react/dist/esm/icons/scan-qr-code.js [app-client] (ecmascript) <export default as ScanQrCode>");
...
function VolunteerFlyerPage() {
    ...
    const signupUrl = ("TURBOPACK compile-time truthy", 1) ? `${window.location.origin}/signup/${db.MOCK_CHURCH_ID}` : ("TURBOPACK unreachable", undefined);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "VolunteerFlyerPage.useEffect": ()=>{
            const fetchRolesAndDescriptions = {
                "VolunteerFlyerPage.useEffect.fetchRolesAndDescriptions": async ()=>{
                    setIsLoading(true);
                    const universalRoles = await db.getUniversalRoles();
                    const roleNames = universalRoles.map({
                        "VolunteerFlyerPage.useEffect.fetchRolesAndDescriptions.roleNames": (r)=>r.name
                    }["VolunteerFlyerPage.useEffect.fetchRolesAndDescriptions.roleNames"]);
                    try {
                        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$data$3a$589060__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["generateRoleDescriptions"])({
                            roles: roleNames
                        });
                        const rolesWithDescriptions = universalRoles.map({
                            "VolunteerFlyerPage.useEffect.fetchRolesAndDescriptions.rolesWithDescriptions": (role)=>{
                                const found = result.descriptions.find({
                                    "VolunteerFlyerPage.useEffect.fetchRolesAndDescriptions.rolesWithDescriptions.found": (d)=>d.roleName === role.name
                                }["VolunteerFlyerPage.useEffect.fetchRolesAndDescriptions.rolesWithDescriptions.found"]);
                                return {
                                    ...role,
                                    description: found?.description || 'Help out where needed!'
                                };
                            }
                        }["VolunteerFlyerPage.useEffect.fetchRolesAndDescriptions.rolesWithDescriptions"]);
                        setRoles(rolesWithDescriptions);
                    } catch (error) {
                        console.error("Failed to generate role descriptions:", error);
                        // Fallback to just names if AI fails
                        const rolesWithFallback = universalRoles.map({
                            "VolunteerFlyerPage.useEffect.fetchRolesAndDescriptions.rolesWithFallback": (r)=>({
                                    ...r,
                                    description: 'Help out where needed!'
                                })
                        }["VolunteerFlyerPage.useEffect.fetchRolesAndDescriptions.rolesWithFallback"]);
                        setRoles(rolesWithFallback);
                    } finally{
                        setIsLoading(false);
                    }
                }
            }["VolunteerFlyerPage.useEffect.fetchRolesAndDescriptions"];
...
_s(VolunteerFlyerPage, "MmBVVG2oVEJzWIR02TF7/DV+9Us=", false, function() {
    return [
...
_c = VolunteerFlyerPage;
var _c;
__turbopack_context__.k.register(_c, "VolunteerFlyerPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
"[project]/node_modules/lucide-react/dist/esm/icons/scan-qr-code.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const ScanQrCode = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$createLucideIcon$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])("ScanQrCode", __iconNode);
;
 //# sourceMappingURL=scan-qr-code.js.map
}}),
"[project]/node_modules/lucide-react/dist/esm/icons/scan-qr-code.js [app-client] (ecmascript) <export default as ScanQrCode>": ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=_621e84d5._.js.map