...
function ShareableSchedulePage({ params: { churchId } }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ShareableSchedulePage.useEffect": ()=>{
            const fetchData = {
                "ShareableSchedulePage.useEffect.fetchData": async ()=>{
                    setIsLoading(true);
                    try {
                        ...
                        if (churchData && churchData.id === churchId) {
                            ...
                            const upcomingEvents = allEvents.filter({
                                "ShareableSchedulePage.useEffect.fetchData.upcomingEvents": (event)=>{
                                    const eventMonth = `${event.eventDate.getFullYear()}-${String(event.eventDate.getMonth() + 1).padStart(2, '0')}`;
                                    // Only show upcoming events from published months
                                    return !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$isPast$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isPast"])(event.eventDate) && publishedMonths.includes(eventMonth);
                                }
                            }["ShareableSchedulePage.useEffect.fetchData.upcomingEvents"]).sort({
                                "ShareableSchedulePage.useEffect.fetchData.upcomingEvents": (a, b)=>a.eventDate.getTime() - b.eventDate.getTime()
                            }["ShareableSchedulePage.useEffect.fetchData.upcomingEvents"]);
            ...
            }["ShareableSchedulePage.useEffect.fetchData"];
            fetchData();
        }
    }["ShareableSchedulePage.useEffect"], [
        churchId,
...
_s(ShareableSchedulePage, "3xq0f0LtYv3xg3YHMKQM3tmsUUs=", false, function() {
    return [
...
_c = ShareableSchedulePage;
var _c;
__turbopack_context__.k.register(_c, "ShareableSchedulePage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_e3bbafcf._.js.map