...
function SettingsPage() {
    _s();
    const { dataService, churchId, isLoggedIn, isAdmin } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$auth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SettingsPage.useEffect": ()=>{
            ...
            const unsubscribe = dataService.getChurch(churchId, {
                "SettingsPage.useEffect.unsubscribe": (churchData)=>{
                    if (churchData) {
                        ...
                        form.reset({
                            ...
                            adminName: churchData.adminName || '',
                            adminEmail: churchData.adminEmail || ''
                        });
                    }
                }
    ...
    const onSubmit = async (data)=>{
        if (!churchId || !dataService) return;
        setIsSaving(true);
        try {
            await dataService.updateChurch(churchId, data);
            toast({
    ...
    if (!isLoggedIn || !isAdmin || !dataService) {
        return null;
    }
...
_s(SettingsPage, "5c641A4GsFMRme3709iYCvfUaQM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$auth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"],
...
//# sourceMappingURL=src_02a753a6._.js.map