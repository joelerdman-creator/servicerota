...
function AuthProvider({ children }) {
    ...
    const { user: firebaseUser, isUserLoading: isAuthServiceLoading };
        ...
        "AuthProvider.useEffect": ()=>{
            const processRedirect = {
                "AuthProvider.useEffect.processRedirect": async ()=>{
                    try {
                        // This is the definitive fix, based on the user's provided documentation.
                        // We set the persistence to a robust option BEFORE trying to get the result.
                        ...
                        // Now, we can safely get the redirect result.
...
_s(AuthProvider, "OIvilnc0wWDI+fIgwXIUX2tfl3k=", false, function() {
    return [
...
//# sourceMappingURL=src_044ffeff._.js.map