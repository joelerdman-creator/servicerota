...
function AdminPage() {
    _s();
    const { dataService, churchId, isAdmin, isLoggedIn } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$auth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminPage.useEffect": ()=>{
            ...
            setIsLoading(true);
            const unsubs = [];
            unsubs.push(dataService.getEvents(churchId, setEvents));
            unsubs.push(dataService.getVolunteers(churchId, setVolunteers));
            unsubs.push(dataService.getServiceTemplates(churchId, setTemplates));
            // A simple way to check if initial loading is done.
            const loadingTimeout = setTimeout({
                "AdminPage.useEffect.loadingTimeout": ()=>setIsLoading(false)
            }["AdminPage.useEffect.loadingTimeout"], 1500);
            unsubs.push({
                "AdminPage.useEffect": ()=>clearTimeout(loadingTimeout)
            }["AdminPage.useEffect"]);
            return ({
                "AdminPage.useEffect": ()=>unsubs.forEach({
                        "AdminPage.useEffect": (unsub)=>unsub()
                    }["AdminPage.useEffect"])
            })["AdminPage.useEffect"];
        }
    }["AdminPage.useEffect"], [
...
_s(AdminPage, "tRYQ4H9iWuOYVFVCF3MZy87l53c=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$auth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
...
//# sourceMappingURL=src_059755b5._.js.map