...
_s(useMockDatabase, "M3nhz7G9Jf6+0r3JDbJUV+VlPF0=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
const preferencesSchema = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"])({
    ...
    serveWithFamily: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["boolean"])().default(false),
        ...
        "MyPreferencesPage.useEffect": ()=>{
            if (isLoggedIn) {
                const vol = db.getVolunteersSync().find({
                    "MyPreferencesPage.useEffect.vol": (v)=>v.id === db.MOCK_VOLUNTEER_ID
...
_s(MyPreferencesPage, "L5PlQ0/zHY9posHQzESSVCMgr9M=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMockDatabase"],
...
//# sourceMappingURL=src_073a52e5._.js.map