...
function AuthProvider({ children }) {
    ...
    const isLoggedIn = !!appUser && !!fbUser;
    const createFirstAdminAndChurch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[createFirstAdminAndChurch]": async (user)=>{
            ...
            const churchRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(firestore, 'churches', churchId);
            const newChurch = {
                id: churchId,
                name: `${user.displayName}'s Church`,
                address: "",
                phone: "",
                adminName: user.displayName || 'Admin',
                adminEmail: user.email || ''
            };
            batch.set(churchRef, newChurch);
    ...
    }["AuthProvider.useCallback[createFirstAdminAndChurch]"], [
        firestore
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            const handleAuthChange = {
                "AuthProvider.useEffect.handleAuthChange": async ()=>{
                    setIsAppLoading(true);
                    if (fbUser && firestore) {
                        let userProfile = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDoc"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(firestore, 'users', fbUser.uid)).then({
                            "AuthProvider.useEffect.handleAuthChange": (d)=>d.exists() ? d.data() : null
                        }["AuthProvider.useEffect.handleAuthChange"]);
                        if (!userProfile) {
                            const adminsQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(firestore, 'users'), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["where"])('role', '==', 'admin'), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["limit"])(1));
                            const adminSnapshot = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDocs"])(adminsQuery);
                            if (adminSnapshot.empty) {
                                userProfile = await createFirstAdminAndChurch(fbUser);
                            } else {
                                const roleSelected = sessionStorage.getItem(`role_selected_${fbUser.uid}`);
                                if (!roleSelected && !pathname.startsWith('/role-selection')) {
                                    const churchIdFromUrl = adminSnapshot.docs[0].data().churchId;
                                    router.push(`/role-selection?churchId=${churchIdFromUrl}`);
                                    setIsAppLoading(false); // Stop loading, let onboarding handle it
                                    return;
                                }
                                // User is new but not the first admin, and has been through role selection
                                // We need to re-fetch their just-created profile
                                userProfile = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDoc"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(firestore, 'users', fbUser.uid)).then({
                                    "AuthProvider.useEffect.handleAuthChange": (d)=>d.exists() ? d.data() : null
                                }["AuthProvider.useEffect.handleAuthChange"]);
                                if (!userProfile) {
                                    // This can happen if they close the tab during role selection.
                                    // Treat as logged out for now.
                        ...
                        const storedView = sessionStorage.getItem(`isAdminView_${fbUser.uid}`);
                        setIsAdminView(storedView !== null ? storedView === 'true' && isTrulyAdmin : isTrulyAdmin);
    ...
    const logout = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[logout]": async ()=>{
            if (appUser) {
                sessionStorage.removeItem(`isAdminView_${appUser.uid}`);
            }
            if (auth) {
...
_s(AuthProvider, "NZh9lrcn1ISvoK0XCIe32Rbxm6U=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFirebase"],
...
//# sourceMappingURL=src_095418c9._.js.map