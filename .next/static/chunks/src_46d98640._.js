    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FirebaseProvider.useEffect": ()=>{
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2d$8e6e89cb$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__z__as__onAuthStateChanged$3e$__["onAuthStateChanged"])(auth, {
                "FirebaseProvider.useEffect.unsubscribe": (user)=>{
                    setUser(user);
...
_s2(useMemoFirebase, "nwk+m61qLgjDVUp4IGV/072DDN4=");
const useUser = ()=>{
    _s3();
...
_s3(useUser, "huZTQEv0vojfA8ahUwgbOjgU01Y=", false, function() {
    return [
        useFirebase
    ];
});
...
function FirebaseClientProvider({ children }) {
    ...
    const instances = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "FirebaseClientProvider.useMemo[instances]": ()=>{
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initializeFirebase"])();
        }
    }["FirebaseClientProvider.useMemo[instances]"], []);
...
_s(FirebaseClientProvider, "XfQbZQ0OqsQJrsiFIOKEX+3MXns=");
                ...
                "useCollection.useEffect.unsubscribe": async (err)=>{
                    ...
                    if (err.code === 'permission-denied') {
                        const permissionError = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$errors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FirestorePermissionError"]({
                            path: query._path?.canonicalString() || 'undefined',
                            operation: 'list'
                        });
...
function useDoc(docRef, options) {
    ...
    const [isLoading, setIsLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const [error, setError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const docRefRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useDoc.useEffect": ()=>{
            if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["refEqual"])(docRef || null, docRefRef.current || null)) {
        ...
        "useDoc.useEffect": ()=>{
            ...
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(docRefRef.current, {
                ...
                "useDoc.useEffect.unsubscribe": async (err)=>{
                    setError(err);
                    setIsLoading(false);
                    // This check is now safer because we guard against null docRefRef.current above
...
{
__turbopack_context__.s({});
// Barrel file for all firebase-related exports
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/firebase/provider.tsx [app-client] (ecmascript)");
...
function AuthProvider({ children }) {
    _s();
    const { firestore, auth, user: firebaseUser, isUserLoading: isAuthLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFirebase"])();
    ...
    const [isTrulyAdmin, setIsTrulyAdmin] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
                ...
                "AuthProvider.useEffect.processUser": async ()=>{
                    ...
                    if (firebaseUser) {
                        ...
                        if (userDoc.exists()) {
                            ...
                            setIsAdminView(shouldBeAdminView && userIsAdmin);
                        } else {
                            const isRoleSelectionPage = pathname.startsWith('/role-selection');
                            const isSignupPage = pathname.startsWith('/signup');
                            if (!isRoleSelectionPage && !isSignupPage) {
                                const churchIdFromUrl = new URLSearchParams(window.location.search).get('churchId');
                                const path = churchIdFromUrl ? `/role-selection?churchId=${churchIdFromUrl}` : '/role-selection';
                                router.push(path);
                            }
                        }
                    } else {
                        ...
                        if (mockLogin) {
                            ...
                            setIsTrulyAdmin(mockIsAdmin);
                            setChurchId(MOCK_CHURCH_ID);
                        } else {
                            setUseMock(false);
                            setIsAdminView(false);
                            setIsTrulyAdmin(false);
                            setChurchId(null);
                            const publicPages = [
                                '/',
                                '/role-selection'
    ...
    const setupMockUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[setupMockUser]": async (isAdmin)=>{
            ...
            const { church, volunteers, events, universalRoles, serviceTemplates, volunteerAvailability, families } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2d$lazy$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMockData"])();
            ...
            volunteers.forEach({
                "AuthProvider.useCallback[setupMockUser]": (v)=>{
                    batch.set((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(firestore, 'users', v.id), v);
                }
            }["AuthProvider.useCallback[setupMockUser]"]);
            events.forEach({
                "AuthProvider.useCallback[setupMockUser]": (e)=>{
                    const eventData = {
                        ...e,
                        eventDate: e.eventDate
                    };
                    batch.set((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(firestore, 'churches', church.id, 'events', e.id), eventData);
                }
            }["AuthProvider.useCallback[setupMockUser]"]);
            universalRoles.forEach({
                "AuthProvider.useCallback[setupMockUser]": (ur)=>{
                    batch.set((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(firestore, 'churches', church.id, 'universalRoles', ur.id), ur);
                }
            }["AuthProvider.useCallback[setupMockUser]"]);
            serviceTemplates.forEach({
                "AuthProvider.useCallback[setupMockUser]": (st)=>{
                    batch.set((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(firestore, 'churches', church.id, 'serviceTemplates', st.id), st);
                }
            }["AuthProvider.useCallback[setupMockUser]"]);
            volunteerAvailability.forEach({
                "AuthProvider.useCallback[setupMockUser]": (va)=>{
                    const availabilityData = {
                        ...va,
                        unavailableDates: va.unavailableDates
                    };
                    batch.set((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(firestore, 'churches', church.id, 'volunteerAvailability', va.volunteerId), availabilityData);
                }
            }["AuthProvider.useCallback[setupMockUser]"]);
            families.forEach({
                "AuthProvider.useCallback[setupMockUser]": (f)=>{
                    batch.set((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(firestore, 'churches', church.id, 'families', f.id), f);
                }
            }["AuthProvider.useCallback[setupMockUser]"]);
            await batch.commit();
            setUseMock(true);
            ...
            setChurchId(MOCK_CHURCH_ID);
            setIsAppLoading(false);
            router.push(isAdmin ? '/admin' : '/my-schedule');
        }
    }["AuthProvider.useCallback[setupMockUser]"], [
        router,
        firestore
    ...
    const toggleAdmin = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[toggleAdmin]": ()=>{
            if (!isLoggedIn || !isTrulyAdmin) return;
            const newIsAdminView = !isAdminView;
            if (firebaseUser) {
                sessionStorage.setItem(`isAdminView_${firebaseUser.uid}`, String(newIsAdminView));
            } else {
...
_s(AuthProvider, "h0paxFkXIvHbu19wQVnRO8zhe7M=", false, function() {
    return [
...
__turbopack_context__.s({
    ...
    "initializeFirebase": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initializeFirebase"]),
    "useCollection": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$firestore$2f$use$2d$collection$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCollection"]),
    "useDoc": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$firestore$2f$use$2d$doc$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDoc"]),
...
//# sourceMappingURL=src_46d98640._.js.map