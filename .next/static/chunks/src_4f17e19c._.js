        ...
        "FirebaseErrorListener.useEffect": ()=>{
            const handleError = {
                "FirebaseErrorListener.useEffect.handleError": (error)=>{
                    ...
                    // This provides a much better debugging experience than just console.logging it.
                    throw error;
                }
...
_s(FirebaseErrorListener, "OD7bBpZva5O2jO+Puf00hKivP7c=");
...
__turbopack_context__.s({
    ...
    "useAuthInstance": (()=>useAuthInstance),
...
_s2(useAuthInstance, "OT++aEmwDNADnnUbJWMr+/+OlXk=", false, function() {
    return [
        useFirebase
    ];
});
...
// Custom deep comparison function for arrays
const deepCompare = (a, b)=>{
    ...
    // This is a simplified comparison, can be expanded for objects
    try {
...
function useMemoFirebase(factory, deps) {
    _s5();
    const prevDeps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(deps);
    const memoizedValue = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    if (memoizedValue.current === null || !deepCompare(prevDeps.current, deps)) {
        prevDeps.current = deps;
        memoizedValue.current = factory();
    }
    return memoizedValue.current;
}
_s5(useMemoFirebase, "1P0ixC32lsgBdwUaHnMBeKjv3JE=");
const useUser = ()=>{
    _s6();
...
function useCollection(query, options) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useCollection.useEffect": ()=>{
            // If the query is not yet available, reset the state and do nothing.
            if (!query) {
                setData(null);
                setIsLoading(true); // Set to true because we are likely waiting for dependencies
                setError(null);
                return;
            }
            setIsLoading(true);
        ...
        query,
        user
    ]); // The effect re-runs whenever the query object or user changes.
    return {
        data,
        isLoading,
        error
...
_s(useCollection, "iY8sS0v5KaQPl1CuQUGL2DpBwIM=", false, function() {
    return [
...
function useDoc(docRef, options) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useDoc.useEffect": ()=>{
            // This is the critical guard. If the docRef is null or undefined, reset state and do nothing.
            if (!docRef) {
                setIsLoading(false);
                setData(null);
                setError(null);
        ...
        docRef,
        user
    ]); // The effect re-runs whenever the docRef object or user changes.
    return {
        data,
        isLoading,
        error
...
_s(useDoc, "iY8sS0v5KaQPl1CuQUGL2DpBwIM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFirebase"]
    ];
});
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2d$lazy$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/mock-data-lazy.ts [app-client] (ecmascript)");
;
...
function AuthProvider({ children }) {
    _s();
    const { firestore, auth, user: fbUser, isUserLoading: isAuthLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFirebase"])();
    ...
    const isUserLoading = isAuthLoading || isAppLoading;
    const isLoggedIn = !!appUser;
    const loadUserProfile = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[loadUserProfile]": async (user)=>{
            ...
            const roleSelected = sessionStorage.getItem(`role_selected_${user.uid}`);
            if (roleSelected) {
                return null; // Don't auto-create if they have selected a role
            }
            // If no profile exists and it's a new user, prepare to create one.
    ...
    }["AuthProvider.useCallback[loadUserProfile]"], [
        firestore,
        router,
        pathname
    ]);
    const createInitialAdminProfile = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[createInitialAdminProfile]": async (user)=>{
            if (!firestore) return null;
            const { church } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2d$lazy$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMockData"])();
            const churchRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(firestore, 'churches', church.id);
            const churchSnap = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDoc"])(churchRef);
            if (!churchSnap.exists()) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setDoc"])(churchRef, church);
            }
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setDoc"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(firestore, 'users', user.uid), newUserProfile);
            return newUserProfile;
        }
    }["AuthProvider.useCallback[createInitialAdminProfile]"], [
        firestore
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            const handleAuthChange = {
                "AuthProvider.useEffect.handleAuthChange": async (firebaseUser)=>{
                    setIsAppLoading(true);
                    if (firebaseUser) {
                        let userProfile = await loadUserProfile(firebaseUser);
                        if (!userProfile) {
                            const roleSelected = sessionStorage.getItem(`role_selected_${firebaseUser.uid}`);
                            if (!roleSelected && !pathname.startsWith('/role-selection')) {
                                router.push('/role-selection');
                                setIsAppLoading(false);
                                return;
                            }
                            // if they selected a role, we let the role selection page handle profile creation
                            setIsAppLoading(false);
                            return;
                        }
                        const isTrulyAdmin = userProfile.role === 'admin';
                        const storedView = sessionStorage.getItem(`isAdminView_${firebaseUser.uid}`);
                        const shouldBeAdminView = storedView !== null ? storedView === 'true' : isTrulyAdmin;
                        const enrichedUser = {
                            ...firebaseUser,
                            ...
                            // This is the critical simulation of custom claims on the token
                            token: {
                                admin: isTrulyAdmin,
                                churchId: userProfile.churchId,
                        ...
                        setIsAdminView(shouldBeAdminView && isTrulyAdmin);
                    } else {
                        // No Firebase user
                        setAppUser(null);
                        ...
                        const isPublic = publicPages.includes(pathname) || pathname.startsWith('/signup/') || pathname.startsWith('/share/');
                        if (!isPublic) {
                            router.push('/');
                        }
                    }
    ...
    const signInAsAdmin = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[signInAsAdmin]": async ()=>{
            if (!auth || !firestore) return;
            const { volunteers, church, events, serviceTemplates, universalRoles, families, volunteerAvailability } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2d$lazy$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMockData"])();
            const adminUser = volunteers.find({
                "AuthProvider.useCallback[signInAsAdmin].adminUser": (v)=>v.id === MOCK_ADMIN_ID
            }["AuthProvider.useCallback[signInAsAdmin].adminUser"]);
            const batch = writeBatch(firestore);
            batch.set((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(firestore, 'churches', church.id), church);
            volunteers.forEach({
                "AuthProvider.useCallback[signInAsAdmin]": (v)=>batch.set((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(firestore, 'users', v.id), v)
            }["AuthProvider.useCallback[signInAsAdmin]"]);
            events.forEach({
                "AuthProvider.useCallback[signInAsAdmin]": (e)=>batch.set((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(firestore, 'churches', MOCK_CHURCH_ID, 'events', e.id), e)
            }["AuthProvider.useCallback[signInAsAdmin]"]);
            serviceTemplates.forEach({
                "AuthProvider.useCallback[signInAsAdmin]": (t)=>batch.set((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(firestore, 'churches', MOCK_CHURCH_ID, 'serviceTemplates', t.id), t)
            }["AuthProvider.useCallback[signInAsAdmin]"]);
            universalRoles.forEach({
                "AuthProvider.useCallback[signInAsAdmin]": (r)=>batch.set((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(firestore, 'churches', MOCK_CHURCH_ID, 'universalRoles', r.id), r)
            }["AuthProvider.useCallback[signInAsAdmin]"]);
            families.forEach({
                "AuthProvider.useCallback[signInAsAdmin]": (f)=>batch.set((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(firestore, 'churches', MOCK_CHURCH_ID, 'families', f.id), f)
            }["AuthProvider.useCallback[signInAsAdmin]"]);
            volunteerAvailability.forEach({
                "AuthProvider.useCallback[signInAsAdmin]": (va)=>batch.set((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(firestore, 'churches', MOCK_CHURCH_ID, 'volunteerAvailability', va.volunteerId), va)
            }["AuthProvider.useCallback[signInAsAdmin]"]);
            await batch.commit();
            const simulatedUser = {
                ...{},
    ...
    const signInAsVolunteer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[signInAsVolunteer]": async ()=>{
            if (!auth || !firestore) return;
            const { volunteers, church, events, serviceTemplates, universalRoles, families, volunteerAvailability } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2d$lazy$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMockData"])();
            const volunteerUser = volunteers.find({
                "AuthProvider.useCallback[signInAsVolunteer].volunteerUser": (v)=>v.id === MOCK_VOLUNTEER_ID
            }["AuthProvider.useCallback[signInAsVolunteer].volunteerUser"]);
            const batch = writeBatch(firestore);
            batch.set((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(firestore, 'churches', church.id), church);
            volunteers.forEach({
                "AuthProvider.useCallback[signInAsVolunteer]": (v)=>batch.set((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(firestore, 'users', v.id), v)
            }["AuthProvider.useCallback[signInAsVolunteer]"]);
            events.forEach({
                "AuthProvider.useCallback[signInAsVolunteer]": (e)=>batch.set((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(firestore, 'churches', MOCK_CHURCH_ID, 'events', e.id), e)
            }["AuthProvider.useCallback[signInAsVolunteer]"]);
            serviceTemplates.forEach({
                "AuthProvider.useCallback[signInAsVolunteer]": (t)=>batch.set((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(firestore, 'churches', MOCK_CHURCH_ID, 'serviceTemplates', t.id), t)
            }["AuthProvider.useCallback[signInAsVolunteer]"]);
            universalRoles.forEach({
                "AuthProvider.useCallback[signInAsVolunteer]": (r)=>batch.set((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(firestore, 'churches', MOCK_CHURCH_ID, 'universalRoles', r.id), r)
            }["AuthProvider.useCallback[signInAsVolunteer]"]);
            families.forEach({
                "AuthProvider.useCallback[signInAsVolunteer]": (f)=>batch.set((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(firestore, 'churches', MOCK_CHURCH_ID, 'families', f.id), f)
            }["AuthProvider.useCallback[signInAsVolunteer]"]);
            volunteerAvailability.forEach({
                "AuthProvider.useCallback[signInAsVolunteer]": (va)=>batch.set((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(firestore, 'churches', MOCK_CHURCH_ID, 'volunteerAvailability', va.volunteerId), va)
            }["AuthProvider.useCallback[signInAsVolunteer]"]);
            await batch.commit();
            const simulatedUser = {
                ...{},
                uid: volunteerUser.id,
                displayName: volunteerUser.name,
                email: volunteerUser.email,
                role: 'volunteer',
                churchId: volunteerUser.churchId,
                isTrulyAdmin: false,
                token: {
                    admin: false,
                    churchId: volunteerUser.churchId
    ...
    const logout = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[logout]": async ()=>{
            ...
            // After sign out, onAuthStateChanged will fire and handle redirection.
            router.push('/');
        }
    ...
    const toggleAdmin = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[toggleAdmin]": ()=>{
            if (!isLoggedIn || !appUser?.isTrulyAdmin) return;
            const newIsAdminView = !isAdminView;
            sessionStorage.setItem(`isAdminView_${appUser.uid}`, String(newIsAdminView));
    ...
    const value = {
        ...
        isAdmin: isAdminView,
        isUserLoading,
        churchId: appUser?.churchId || null,
        ...
        toggleAdmin,
        firebaseUser: fbUser,
        isTrulyAdmin: appUser?.isTrulyAdmin || false
    };
...
_s(AuthProvider, "3pP7kX+room32YwkaKd9y46zoXw=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFirebase"],
...
__turbopack_context__.s({
    ...
    "useAuthInstance": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthInstance"]),
    "useCollection": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$hooks$2f$use$2d$collection$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCollection"]),
    "useDoc": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$hooks$2f$use$2d$doc$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDoc"]),
...
__turbopack_context__.s({
    ...
    "useAuthInstance": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__["useAuthInstance"]),
...
//# sourceMappingURL=src_4f17e19c._.js.map