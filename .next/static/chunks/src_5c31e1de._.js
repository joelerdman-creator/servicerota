        ...
        "useMockDatabase.useCallback[toggleVolunteerAvailability]": async (volunteerId, date)=>{
            setAvailability({
                "useMockDatabase.useCallback[toggleVolunteerAvailability]": (prev)=>{
                    const availabilityRecord = prev.find({
                        "useMockDatabase.useCallback[toggleVolunteerAvailability].availabilityRecord": (a)=>a.volunteerId === volunteerId
                    }["useMockDatabase.useCallback[toggleVolunteerAvailability].availabilityRecord"]);
                    if (availabilityRecord) {
                        const dateExists = availabilityRecord.unavailableDates.some({
                        ...
                        const updatedDates = dateExists ? availabilityRecord.unavailableDates.filter({
...
_s(useMockDatabase, "TkviT6y9ld3THUNCJu0qAdEHJJQ=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_5c31e1de._.js.map