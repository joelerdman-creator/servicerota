...
function useMockDatabase() {
    ...
    const createEvent = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useMockDatabase.useCallback[createEvent]": async (newEventData)=>{
            const newEvent = {
                ...newEventData,
                id: `event_${Date.now()}`,
                churchId: MOCK_CHURCH_ID,
...
_s(useMockDatabase, "tqZ9ky2K1Ms3RYlNT40MWkXFgtU=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
_s(CreateEventModal, "3BlcuXlwSTiKqal0RpeuxdEEkIw=", false, function() {
    return [
...
//# sourceMappingURL=src_67dd0ada._.js.map