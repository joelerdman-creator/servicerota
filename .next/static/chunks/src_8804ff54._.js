...
// Custom deep comparison function for Firestore queries and doc refs
function isEqual(a, b) {
    if (a === b) return true;
    if (!a || !b) return false;
    // Handle Firestore Query and DocumentReference objects
    if (typeof a.isEqual === 'function') {
        return a.isEqual(b);
    }
    // Fallback for primitive types and other objects, though primarily for the above
...
function useDeepCompareMemoize(value) {
    ...
    if (!value.every((v, i)=>isEqual(v, ref.current?.[i]))) {
        ref.current = value;
    }
    return ref.current;
}
_s2(useDeepCompareMemoize, "QMBuJFIdzLIeqBcFwhMf246mjOM=");
function useMemoFirebase(factory, deps) {
    _s3();
    // eslint-disable-next-line react-hooks/exhaustive-deps
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])(factory, useDeepCompareMemoize(deps));
}
_s3(useMemoFirebase, "nwk+m61qLgjDVUp4IGV/072DDN4=");
const useUser = ()=>{
    _s4();
...
_s4(useUser, "huZTQEv0vojfA8ahUwgbOjgU01Y=", false, function() {
    return [
        useFirebase
    ];
});
...
function useCollection(query, options) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        ...
        query
    ]); // The effect re-runs whenever the query object changes.
    return {
        data,
        isLoading,
        error
...
function useDoc(docRef, options) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        ...
        docRef
    ]); // The effect re-runs whenever the docRef object changes.
    return {
        data,
        isLoading,
        error
...
function AuthProvider({ children }) {
    ...
    const setupMockUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[setupMockUser]": async (isAdmin)=>{
            ...
            const { getMockData } = await __turbopack_context__.r("[project]/src/lib/mock-data-lazy.ts [app-client] (ecmascript, async loader)")(__turbopack_context__.i);
            const { church, volunteers, events, universalRoles, serviceTemplates, volunteerAvailability, families } = getMockData();
...
//# sourceMappingURL=src_8804ff54._.js.map