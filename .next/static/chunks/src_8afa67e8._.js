...
"[project]/src/app/my-availability/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function MyAvailabilityPage() {
    _s();
    const { churchId, userId, isLoggedIn, isAdmin, user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$auth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    const { firestore } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFirebase"])();
    ...
    const familyDocRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemoFirebase"])({
        "MyAvailabilityPage.useMemoFirebase[familyDocRef]": ()=>firestore && churchId && user?.familyId ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(firestore, 'churches', churchId, 'families', user.familyId) : null
    }["MyAvailabilityPage.useMemoFirebase[familyDocRef]"], [
        firestore,
        churchId,
        user
    ]);
    const { data: family } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$hooks$2f$use$2d$doc$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDoc"])(familyDocRef);
    const availabilityDocRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemoFirebase"])({
        "MyAvailabilityPage.useMemoFirebase[availabilityDocRef]": ()=>{
            if (!firestore || !churchId || !selectedMemberId || selectedMemberId === 'all') return null;
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(firestore, 'churches', churchId, 'volunteerAvailability', selectedMemberId);
        }
    }["MyAvailabilityPage.useMemoFirebase[availabilityDocRef]"], [
        firestore,
        churchId,
    ...
    const unavailableDays = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MyAvailabilityPage.useMemo[unavailableDays]": ()=>(availability?.unavailableDates || []).map({
                "MyAvailabilityPage.useMemo[unavailableDays]": (d)=>d instanceof Date ? d : d.toDate()
            }["MyAvailabilityPage.useMemo[unavailableDays]"])
    }["MyAvailabilityPage.useMemo[unavailableDays]"], [
        availability
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MyAvailabilityPage.useEffect": ()=>{
            if (!isLoggedIn) {
                router.push('/');
            } else if (isAdmin) {
                router.push('/admin');
    ...
    const toggleAvailability = (day)=>{
        if (!firestore || !churchId || !selectedMemberId || selectedMemberId === 'all') {
            if (selectedMemberId === 'all') {
                toast({
                    variant: 'destructive',
                    title: 'Cannot Modify All',
                    description: 'Please select an individual family member to modify availability.'
                });
            }
            return;
        }
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setDoc"])(availabilityDocRef, availabilityData, {
            ...
            toast({
                ...
                description: `You marked ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(day, 'PPP')} as ${!isCurrentlyUnavailable ? 'unavailable' : 'available'}.`
            });
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    family && user?.preferences.familyManagementEnabled && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Select"], {
...
_s(MyAvailabilityPage, "iFzXAxKe+zPPnSV2WQ6oE2QyKU0=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$auth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFirebase"],
...
_c = MyAvailabilityPage;
var _c;
__turbopack_context__.k.register(_c, "MyAvailabilityPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_8afa67e8._.js.map