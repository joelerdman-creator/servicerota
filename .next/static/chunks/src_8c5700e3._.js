...
function MyAvailabilityPage() {
    ...
    const handleDayClick = async (day, { selected })=>{
        ...
        toast({
            ...
            description: `You marked ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(day, 'PPP')} as ${selected ? 'available' : 'unavailable'}.`
        });
    };
    if (!isLoggedIn || isAdmin) {
        return null; // Or a loading/redirecting component
    }
    const footer = unavailableDays && unavailableDays.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s(MyAvailabilityPage, "pP1r1b1/BuxY56Re2cpRUVJb2BE=", false, function() {
    return [
...
//# sourceMappingURL=src_8c5700e3._.js.map