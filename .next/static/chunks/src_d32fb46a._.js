...
function MyPreferencesPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MyPreferencesPage.useEffect": ()=>{
            if (isLoggedIn) {
                const vol = getVolunteersSync().find({
                    "MyPreferencesPage.useEffect.vol": (v)=>v.id === MOCK_VOLUNTEER_ID
                }["MyPreferencesPage.useEffect.vol"]);
                if (vol) {
                    setVolunteer(vol);
...
_s(MyPreferencesPage, "KoJBo6/gSwXlTG578OM4oIJSNSI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMockDatabase"],
...
//# sourceMappingURL=src_d32fb46a._.js.map