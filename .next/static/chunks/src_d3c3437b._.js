...
function MyAvailabilityPage() {
    ...
    const [selectedMemberId, setSelectedMemberId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(MOCK_VOLUNTEER_ID);
        ...
        "MyAvailabilityPage.useEffect": ()=>{
            if (isLoggedIn) {
                ...
                getVolunteerAvailability(selectedMemberId).then({
                    "MyAvailabilityPage.useEffect": (dates)=>{
                        setUnavailableDays(dates.sort({
                            "MyAvailabilityPage.useEffect": (a, b)=>a.getTime() - b.getTime()
                        }["MyAvailabilityPage.useEffect"]));
                        setIsLoading(false);
                    }
                }["MyAvailabilityPage.useEffect"]);
    ...
    const toggleAvailability = async (day)=>{
        ...
        toast({
            ...
            description: `You marked ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(day, 'PPP')} as ${!initialUnavailable ? 'unavailable' : 'available'}.`
        });
    };
...
_s(MyAvailabilityPage, "+s3qlPIuRFKRbNUnVgZk8Hq5XHo=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMockDatabase"],
...
//# sourceMappingURL=src_d3c3437b._.js.map