...
function generateBulletinText(events, title) {
    ...
    events.forEach((event)=>{
        text += `----------------------------------------\n`;
        text += `${event.eventName.toUpperCase()} - ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(event.eventDate, 'EEEE, MMMM d @ p')}\n`;
        text += `----------------------------------------\n`;
...
function SharePage() {
    ...
    const [bulletinText, setBulletinText] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SharePage.useEffect": ()=>{
            ...
            switch(dateRange){
                case 'this_week':
                    const start = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$startOfWeek$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["startOfWeek"])(now);
                    const end = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$endOfWeek$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["endOfWeek"])(now);
                    ...
                    filteredEvents = events.filter({
                        "SharePage.useEffect": (e)=>e.eventDate >= start && e.eventDate <= end
                    }["SharePage.useEffect"]);
                    break;
                case 'next_7_days':
                    const nextWeek = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$addDays$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDays"])(now, 7);
                    title = `Next 7 Days (${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(now, 'MMM d')} - ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(nextWeek, 'MMM d')})`;
                    filteredEvents = events.filter({
                        "SharePage.useEffect": (e)=>e.eventDate >= now && e.eventDate <= nextWeek
                    }["SharePage.useEffect"]);
                    break;
                case 'this_month':
                    ...
                    filteredEvents = events.filter({
                        "SharePage.useEffect": (e)=>e.eventDate >= startM && e.eventDate <= endM
                    }["SharePage.useEffect"]);
                    break;
            }
...
_s(SharePage, "QUNnCG8cUHSuhwcPvwfvcr+hbIo=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMockDatabase"],
...
//# sourceMappingURL=src_e01aa693._.js.map