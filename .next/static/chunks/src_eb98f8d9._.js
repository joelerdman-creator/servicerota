...
function UniversalRoleManager({ db }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "UniversalRoleManager.useEffect": ()=>{
            const fetchRoles = {
                "UniversalRoleManager.useEffect.fetchRoles": ()=>{
                    db.getUniversalRoles().then({
                        "UniversalRoleManager.useEffect.fetchRoles": (data)=>{
                            setRoles(data.sort({
                                "UniversalRoleManager.useEffect.fetchRoles": (a, b)=>a.name.localeCompare(b.name)
                            }["UniversalRoleManager.useEffect.fetchRoles"]));
                            setIsLoading(false);
                        }
                    }["UniversalRoleManager.useEffect.fetchRoles"]);
            ...
            return ({
                "UniversalRoleManager.useEffect": ()=>clearInterval(interval)
            })["UniversalRoleManager.useEffect"];
        }
    }["UniversalRoleManager.useEffect"], [
        db
...
_s(UniversalRoleManager, "p3Yd7Q27iN/cM8Yj2bHL/g5WGZM=", false, function() {
    return [
...
_s1(ServiceTemplateCard, "rH1rVuex0DBk/D5dUYnpAtnTEQM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"]
    ];
});
...
_s2(NewTemplateCard, "lI65q767/qxTYE4ZNovuEorFoJQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"]
    ];
});
...
function TemplatesPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TemplatesPage.useEffect": ()=>{
            const fetchAllData = {
                "TemplatesPage.useEffect.fetchAllData": ()=>{
                    Promise.all([
                        db.getServiceTemplates(),
                        db.getUniversalRoles()
                    ]).then({
                        "TemplatesPage.useEffect.fetchAllData": ([templateData, roleData])=>{
                            setTemplates(templateData.sort({
                                "TemplatesPage.useEffect.fetchAllData": (a, b)=>a.name.localeCompare(b.name)
                            }["TemplatesPage.useEffect.fetchAllData"]));
                            setUniversalRoles(roleData.sort({
                                "TemplatesPage.useEffect.fetchAllData": (a, b)=>a.name.localeCompare(b.name)
                            }["TemplatesPage.useEffect.fetchAllData"]));
                            setIsLoading(false);
                        }
            ...
            return ({
                "TemplatesPage.useEffect": ()=>clearInterval(interval)
            })["TemplatesPage.useEffect"];
        }
    }["TemplatesPage.useEffect"], [
        db
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(UniversalRoleManager, {
                                db: db
                            }, void 0, false, {
                                fileName: "[project]/src/app/admin/templates/page.tsx",
                                lineNumber: 484,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            templates.map((template)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ServiceTemplateCard, {
                                                    template: template,
...
_s3(TemplatesPage, "lWGHBFo7d4792eK24izpDqXbBr8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMockDatabase"]
    ];
});
...
//# sourceMappingURL=src_eb98f8d9._.js.map