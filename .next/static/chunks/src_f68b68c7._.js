        ...
        "useMockDatabase.useCallback[toggleVolunteerAvailability]": async (volunteerId, date)=>{
            setAvailability({
                "useMockDatabase.useCallback[toggleVolunteerAvailability]": (prevAvailability)=>{
                    ...
                    const isUnavailable = prevAvailability.find({
                        "useMockDatabase.useCallback[toggleVolunteerAvailability]": (a)=>a.volunteerId === (targetIds[0] || '')
                    }["useMockDatabase.useCallback[toggleVolunteerAvailability]"])?.unavailableDates.some({
                    ...
                    }["useMockDatabase.useCallback[toggleVolunteerAvailability]"]) ?? false;
                    targetIds.forEach({
                        "useMockDatabase.useCallback[toggleVolunteerAvailability]": (id)=>{
                            ...
                            if (record) {
                                ...
                                let updatedDates;
                                if (volunteerId === 'all') {
                                    updatedDates = isUnavailable ? record.unavailableDates.filter({
                                        "useMockDatabase.useCallback[toggleVolunteerAvailability]": (d)=>!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$isSameDay$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isSameDay"])(d, date)
                                    }["useMockDatabase.useCallback[toggleVolunteerAvailability]"]) // Make available
                                     : [
                                        ...record.unavailableDates,
                                        date
                                    ]; // Make unavailable
                                } else {
                                    updatedDates = dateExists ? record.unavailableDates.filter({
                                        "useMockDatabase.useCallback[toggleVolunteerAvailability]": (d)=>!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$isSameDay$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isSameDay"])(d, date)
                                    }["useMockDatabase.useCallback[toggleVolunteerAvailability]"]) // Make available
                                     : [
                                        ...record.unavailableDates,
...
_s(useMockDatabase, "2cKuO7ADUyQ1wVwZO6dB0Dk2JPY=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_f68b68c7._.js.map