...
const FirebaseProvider = ({ children, firebaseApp, firestore, auth })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FirebaseProvider.useEffect": ()=>{
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2d$8e6e89cb$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__k__as__getRedirectResult$3e$__["getRedirectResult"])(auth).catch({
                "FirebaseProvider.useEffect": (error)=>{
                    // Handle/report error if needed.
                    // This is often where "account-exists-with-different-credential" errors are caught.
                    console.error("Error getting redirect result:", error);
                    setUserAuthState({
                        "FirebaseProvider.useEffect": (prevState)=>({
                                ...prevState,
                                userError: error
                            })
                    }["FirebaseProvider.useEffect"]);
...
function initiateGoogleSignIn(authInstance) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2d$8e6e89cb$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__g__as__signInWithRedirect$3e$__["signInWithRedirect"])(authInstance, provider);
...
function initializeFirebase() {
    ...
    if ("TURBOPACK compile-time truthy", 1) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2d$8e6e89cb$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__L__as__connectAuthEmulator$3e$__["connectAuthEmulator"])(auth, 'http://127.0.0.1:9099', {
...
function AuthProvider({ children }) {
    ...
    const { user: firebaseUser, isUserLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUser"])();
    const [mockIsLoggedIn, setMockIsLoggedIn] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [mockIsAdmin, setMockIsAdmin] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            // This effect syncs mock state from session storage on initial load
            if ("object" !== 'undefined' && !firebaseUser && !isUserLoading) {
                const loggedInStatus = sessionStorage.getItem('isLoggedIn') === 'true';
                const adminStatus = sessionStorage.getItem('isAdmin') === 'true';
                setMockIsLoggedIn(loggedInStatus);
                setMockIsAdmin(adminStatus);
            }
        }
    }["AuthProvider.useEffect"], [
        firebaseUser,
    ...
    const signInWithGoogle = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[signInWithGoogle]": ()=>{
            if (auth) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$non$2d$blocking$2d$login$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initiateGoogleSignIn"])(auth);
            } else {
...
_s(AuthProvider, "HNr0ImmiOqOMj3CQMlr6cg6qsHU=", false, function() {
    return [
...
__turbopack_context__.s({
    ...
    "initiateGoogleSignIn": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$non$2d$blocking$2d$login$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initiateGoogleSignIn"]),
...
__turbopack_context__.s({
    ...
    "initiateGoogleSignIn": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__["initiateGoogleSignIn"]),
...
//# sourceMappingURL=src_fbf7494f._.js.map